...
- **Mathematics Paper Discovery**: For mathematics, combine general metadata sources
  with [[research-discovery/search/search|arXiv]], zbMATH/OpenAlex/Semantic Scholar, DOI lookup, [[zotero/SKILL|Zotero]], and the local PDF
  workflow.
...
- search metadata with this skill and [[research-discovery/search/search|arxiv]],
