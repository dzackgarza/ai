---
name: arxiv
description: Search [[research-discovery/arxiv/SKILL|arXiv]] papers by keyword, author, category, or
  ID.
license: MIT
metadata:
  hermes:
    ...
    - API
    related_skills:
    - '[[ocr-and-documents/SKILL|ocr-and-documents]]'
  version: 1.0.0
  author: Hermes Agent
---
# [[research-discovery/arxiv/SKILL|arXiv]] Research

Search and retrieve academic papers from [[research-discovery/arxiv/SKILL|arXiv]] via their free REST API. No API key, no
...
[[research-discovery/arxiv/SKILL|arXiv]] doesn’t provide citation data or recommendations.
...
### Search papers (alternative to [[research-discovery/arxiv/SKILL|arXiv]] search, returns JSON)
...
For mathematics papers, [[research-discovery/arxiv/SKILL|arXiv]] is only one source.
Use it together with the [[research-discovery/literature-review/SKILL|literature-review]] skill’s multi-source search and Zotero/PDF
workflows:

- [[research-discovery/arxiv/SKILL|arXiv]] for preprints and TeX/PDF identifiers,
...
`publicationVenue`, `externalIds` (contains [[research-discovery/arxiv/SKILL|arXiv]] ID, DOI, etc.)
...
| API | Rate | Auth |
| --- | --- | --- |
| [[research-discovery/arxiv/SKILL|arXiv]] | ~1 req / 3 seconds | None needed |
| Semantic Scholar | 1 req / second | None (100/sec with API key) |

## Notes

- [[research-discovery/arxiv/SKILL|arXiv]] returns Atom XML — use the helper script or parsing snippet for clean output

- Semantic Scholar returns JSON — pipe through `python3 -m json.tool` for readability

- [[research-discovery/arxiv/SKILL|arXiv]] IDs: old format (`hep-th/0601001`) vs new (`2402.03300`)
