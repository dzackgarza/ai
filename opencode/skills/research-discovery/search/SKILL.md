---
name: arxiv
description: "Search [[research-discovery/search/SKILL|arXiv]] papers by keyword, author, category, or ID."
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
...
---
# [[research-discovery/search/SKILL|arXiv]] Research

Search and retrieve academic papers from [[research-discovery/search/SKILL|arXiv]] via their free REST API. No API key, no
...
[[research-discovery/search/SKILL|arXiv]] doesn’t provide citation data or recommendations.
...
### Search papers (alternative to [[research-discovery/search/SKILL|arXiv]] search, returns JSON)
...
For mathematics papers, [[research-discovery/search/SKILL|arXiv]] is only one source.
...
- [[research-discovery/search/SKILL|arXiv]] for preprints and TeX/PDF identifiers,
...
`publicationVenue`, `externalIds` (contains [[research-discovery/search/SKILL|arXiv]] ID, DOI, etc.)
...
| API | Rate | Auth |
| --- | --- | --- |
| [[research-discovery/search/SKILL|arXiv]] | ~1 req / 3 seconds | None needed |
| Semantic Scholar | 1 req / second | None (100/sec with API key) |

## Notes

- [[research-discovery/search/SKILL|arXiv]] returns Atom XML — use the helper script or parsing snippet for clean output

- Semantic Scholar returns JSON — pipe through `python3 -m json.tool` for readability

- [[research-discovery/search/SKILL|arXiv]] IDs: old format (`hep-th/0601001`) vs new (`2402.03300`)
