...
---
# [[research-discovery/search/search|arXiv]] Research

Search and retrieve academic papers from [[research-discovery/search/search|arXiv]] via their free REST API. No API key, no
...
[[research-discovery/search/search|arXiv]] doesn’t provide citation data or recommendations.
...
### Search papers (alternative to [[research-discovery/search/search|arXiv]] search, returns JSON)
...
For mathematics papers, [[research-discovery/search/search|arXiv]] is only one source.
Use it together with the [[research-discovery/literature-review/literature-review|literature-review]] skill’s multi-source search and Zotero/PDF
workflows:

- [[research-discovery/search/search|arXiv]] for preprints and TeX/PDF identifiers,
...
`publicationVenue`, `externalIds` (contains [[research-discovery/search/search|arXiv]] ID, DOI, etc.)
...
| API | Rate | Auth |
| --- | --- | --- |
| [[research-discovery/search/search|arXiv]] | ~1 req / 3 seconds | None needed |
| Semantic Scholar | 1 req / second | None (100/sec with API key) |

## Notes

- [[research-discovery/search/search|arXiv]] returns Atom XML — use the helper script or parsing snippet for clean output

- Semantic Scholar returns JSON — pipe through `python3 -m json.tool` for readability

- [[research-discovery/search/search|arXiv]] IDs: old format (`hep-th/0601001`) vs new (`2402.03300`)
