...
archive/handoffs/    # frozen historical bundles ([[mathematics/research/references/handoff|handoff]])
```
...
- Alternate theory passes and computation passes; each session's handoff names which
  kind comes next and why ([[mathematics/research/references/handoff|handoff]]).
...
- Run the program as a relay of seats — theory pushes, compute sweeps, audit/banking —
  ...
  under review ([[mathematics/research/references/adversarial-audit|adversarial-audit]]).
