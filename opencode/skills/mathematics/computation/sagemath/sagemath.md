---
name: sagemath
description: Use when working with [[mathematics/computation/sagemath/sagemath|SageMath]] for mathematical computations, algebraic geometry, or number theory
---
# [[mathematics/computation/sagemath/sagemath|SageMath]]

## Overview

Work with canonical mathematical objects, not manual constructions.
[[mathematics/computation/sagemath/sagemath|SageMath]] provides rich algebraic structures—use them.
...
**NEVER** create matrices like `matrix([[1,2],[3,4]])`. Always use [[mathematics/computation/sagemath/sagemath|SageMath]]’s built-in
objects:
