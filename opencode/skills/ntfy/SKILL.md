...
Do not default to incident forensics.
Only do troubleshooting analysis when explicitly requested.
...
- Keep topic names explicit and consistent; topic mismatch is the most common operator
  error.
