...
description: Use when writing, reviewing, or improving a README file — covers anti-slop patterns, structure, what to omit, and how to avoid embarrassing AI-generated boilerplate.
---
...
- [ ] Title contains only the project name
- [ ] Description is 1-3 sentences, no adjectives
- [ ] Installation is copy-pasteable commands (prefer uvx/npx for no-install)
- [ ] Usage shows a working example
- [ ] No sentence is true of any project
- [ ] No badge exists purely for vanity
- [ ] No phrase appears in the "Delete on sight" list
- [ ] No first-person narration
- [ ] Under 200 lines total
- [ ] Every section earns its existence
- [ ] No internal function/variable/module names leaked
- [ ] No CLI help duplicated (say "run `tool --help`")
- [ ] No justfile/Makefile recipe contents duplicated (say "run `just`")
- [ ] No internal dev workflows (CI, release, contributing) — those go in CONTRIBUTING.md
- [ ] Surprises disclosed upfront (cookies, network calls, caching, dependencies)
- [ ] Feature/provider lists are for delineation, not bragging

## Pressure Test

Read the README aloud.
If any sentence sounds like a LinkedIn post, delete it.
