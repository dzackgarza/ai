...
metadata:
  hermes:
    ...
    category: research
    related_skills: [arxiv, ml-paper-writing, [[subagent-delegation/implementation/SKILL|subagent-driven-development]], plan]
...
**Load the [[research-discovery/search/SKILL|arxiv]] skill** for structured paper discovery: `skill_view("arxiv")`. It
provides [[research-discovery/search/SKILL|arXiv]] REST API search, Semantic Scholar citation graphs, author profiles, and
BibTeX generation.
...
figures from institutional tools, acknowledgments left in from a previous draft, [[research-discovery/search/SKILL|arXiv]]
...
### Step 7.9: [[research-discovery/search/SKILL|arXiv]] & Preprint Strategy

Posting to [[research-discovery/search/SKILL|arXiv]] is standard practice in ML but has important timing and anonymity
considerations.
...
| --- | --- |
| Submitting to double-blind venue (NeurIPS, ICML, ACL) | Post to [[research-discovery/search/SKILL|arXiv]] **after** submission deadline, not before. Posting before can technically violate anonymity policies, though enforcement varies. |
| Submitting to ICLR | ICLR explicitly allows [[research-discovery/search/SKILL|arXiv]] posting before submission. But don’t put author names in the submission itself. |
| Paper already on [[research-discovery/search/SKILL|arXiv]], submitting to new venue | Acceptable at most venues. Do NOT update [[research-discovery/search/SKILL|arXiv]] version during review with changes that reference reviews. |
| Workshop paper | [[research-discovery/search/SKILL|arXiv]] is fine at any time — workshops are typically not double-blind. |
| Want to establish priority | Post immediately if scooping is a concern — but accept the anonymity tradeoff. |

**[[research-discovery/search/SKILL|arXiv]] category selection** (ML/AI papers):
...
**Timing**: Post within 1-2 days of paper appearing on proceedings or [[research-discovery/search/SKILL|arXiv]]
camera-ready.
...
| **[[research-discovery/search/SKILL|arXiv]]** | Post anytime | Timing matters (see [[research-discovery/search/SKILL|arXiv]] strategy) |
...
| --- | --- | --- |
| [[research-discovery/search/SKILL|arxiv]] | Phase 1 (Literature Review): searching [[research-discovery/search/SKILL|arXiv]], generating BibTeX, finding related papers via Semantic Scholar | `skill_view("arxiv")` |
...
| **`cronjob`** | Schedule experiment monitoring, deadline countdowns, automated [[research-discovery/search/SKILL|arXiv]] checks. |
