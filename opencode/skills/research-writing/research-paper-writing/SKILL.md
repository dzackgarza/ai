...
**Load the [[research-discovery/arxiv/SKILL|arxiv]] skill** for structured paper discovery: `skill_view("arxiv")`. It
provides [[research-discovery/arxiv/SKILL|arXiv]] REST API search, Semantic Scholar citation graphs, author profiles, and
BibTeX generation.
...
figures from institutional tools, acknowledgments left in from a previous draft, [[research-discovery/arxiv/SKILL|arXiv]]
...
### Step 7.9: [[research-discovery/arxiv/SKILL|arXiv]] & Preprint Strategy

Posting to [[research-discovery/arxiv/SKILL|arXiv]] is standard practice in ML but has important timing and anonymity
considerations.
...
| --- | --- |
| Submitting to double-blind venue (NeurIPS, ICML, ACL) | Post to [[research-discovery/arxiv/SKILL|arXiv]] **after** submission deadline, not before. Posting before can technically violate anonymity policies, though enforcement varies. |
| Submitting to ICLR | ICLR explicitly allows [[research-discovery/arxiv/SKILL|arXiv]] posting before submission. But don’t put author names in the submission itself. |
| Paper already on [[research-discovery/arxiv/SKILL|arXiv]], submitting to new venue | Acceptable at most venues. Do NOT update [[research-discovery/arxiv/SKILL|arXiv]] version during review with changes that reference reviews. |
| Workshop paper | [[research-discovery/arxiv/SKILL|arXiv]] is fine at any time — workshops are typically not double-blind. |
| Want to establish priority | Post immediately if scooping is a concern — but accept the anonymity tradeoff. |

**[[research-discovery/arxiv/SKILL|arXiv]] category selection** (ML/AI papers):
...
**Timing**: Post within 1-2 days of paper appearing on proceedings or [[research-discovery/arxiv/SKILL|arXiv]]
camera-ready.
...
| **[[research-discovery/arxiv/SKILL|arXiv]]** | Post anytime | Timing matters (see [[research-discovery/arxiv/SKILL|arXiv]] strategy) |
...
| --- | --- | --- |
| [[research-discovery/arxiv/SKILL|arxiv]] | Phase 1 (Literature Review): searching [[research-discovery/arxiv/SKILL|arXiv]], generating BibTeX, finding related papers via Semantic Scholar | `skill_view("arxiv")` |
| [[subagent-delegation/subagent-driven-development/SKILL|subagent-driven-development]] | Phase 5 (Drafting): parallel section writing with 2-stage review (spec compliance then quality) | `skill_view("subagent-driven-development")` |
...
| **`cronjob`** | Schedule experiment monitoring, deadline countdowns, automated [[research-discovery/arxiv/SKILL|arXiv]] checks. |
