...
Research-backed prompting techniques and findings.
See linked papers for full details.

* * *

## Rule-Based Prompting

**Citation:** [arxiv:2509.00482](https://arxiv.org/abs/2509.00482) — Tested across
1,000+ agent turns
...
**Conclusion:** Don’t describe WHO the agent is.
Encode WHAT the agent must DO.

* * *

## Parallel Tool Calling (2026)

**Citation:** [arxiv:2602.07359](https://arxiv.org/abs/2602.07359) — “Scaling Parallel
Tool Calling for Efficient Deep Research Agents”
...
**Key insight:** Models don’t process tokens uniformly.
...
**Citation:** “Model Context Protocol (MCP) Tool Descriptions Are Smelly!”
(Hasan et al., 2025)
...
- Multi-agent with Claude Opus 4 (lead) + Claude Sonnet 4 (workers) outperformed
...
The old rule “one tool per turn” was for models with brittle tool-calling capabilities
(2023-2024).
