...
- README: project entry point for evaluation, installation, first use, and
  links to deeper docs. See the **Writing READMEs** section below for the full
...
This section is the README-specific layer on top of the general workflow above. A README
is the repository entry point: it must let a new consumer understand why the repo exists,
decide whether it applies, install it, run a first useful example, verify the result, and
find deeper docs.
...
- [ ] The general documentation workflow and Concision Rule above were followed.
