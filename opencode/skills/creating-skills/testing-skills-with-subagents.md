...
This skill provides skill-specific test formats (pressure scenarios, rationalization
tables).
...
Don’t add extra content for hypothetical cases - write just enough to address the actual
...
**Why this works:** See persuasion-principles.md (in creating-skills directory) for
...
preventing, not what ACTUALLY needs preventing.
