...
> Source: [Anthropic Platform Docs](https://platform.claude.com/docs/en/agents-and-tools/agent-skills/best-practices) and [obra/superpowers](https://github.com/obra/superpowers/blob/main/skills/writing-skills/anthropic-best-practices.md)
...
- Content guidelines (time-sensitivity, terminology)
- Common patterns (template, examples, conditional workflow)
- Evaluation and iteration (eval-driven dev, Claude A/B, observation)
- Anti-patterns to avoid
- Advanced: Skills with executable code (scripts, deps, runtime, MCP)
...
>
> `description`: Non-empty, maximum 1024 characters, no XML tags. Should describe what the Skill does and when to use it.
...
- **Return to Claude A for improvements:** Share the current SKILL.md and describe what you observed
...
- **Repeat based on usage:** Continue this observe-refine-test cycle as you encounter new scenarios
...
The sections below focus on Skills that include executable scripts. If your Skill uses only markdown instructions, skip to the checklist at the end.
