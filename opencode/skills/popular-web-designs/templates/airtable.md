...
“sophisticated simplicity” through a white canvas with deep navy text (`#181d26`) and
Airtable Blue (`#1b61c9`) as the primary interactive accent.
The Haas font family (display + text variants) creates a Swiss-precision typography
...
- Radius: 2px (small), 12px (buttons), 16px (cards), 24px (sections), 32px (large), 50%
  (circles)
