...
- Prefer exact local replacement of adjacent source text over line-number range edits. If inserting a comment requires line arithmetic or regenerating source lines from memory, leave the passage unresolved instead of risking source-body damage.
