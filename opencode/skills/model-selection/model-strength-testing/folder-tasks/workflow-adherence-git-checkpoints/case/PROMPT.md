...
4. Immediately **review the diff** to ensure you did not accidentally strip semantic
   content.
...
1. Update the product name from “Open Code” to “OpenCode” in
   `case/workspace/branding.md`.
