...
- Produce a generic algebraic-geometry proof outline ("construct compactification",
  “analyze boundary”, “use degeneration”) without the paper-specific steps.
...
- 8-10: includes cusp-by-cusp toroidal/semitoroidal statement + double-curve counting as
  a real argument.
