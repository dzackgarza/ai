...
Also load [[writing/agent-audiences/agent-audiences|writing-for-agent-audiences]] before editing subagent prompts or runtime agent
...
| **Exploration/branching** | Tasks requiring trial-and-error, false starts, incorrect guesses. Subagents can churn without derailing main agent. | “Research existing implementations of X across [[research-discovery/search/search|arXiv]] and GitHub” |
...
- → [[writing/agent-audiences/agent-audiences|writing-for-agent-audiences]] — REQUIRED: Load alongside when the audience is an
