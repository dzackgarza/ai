...
Also load [[writing/writing-for-agent-audiences/SKILL|writing-for-agent-audiences]] before editing subagent prompts or runtime agent
...
| **Exploration/branching** | Tasks requiring trial-and-error, false starts, incorrect guesses. Subagents can churn without derailing main agent. | “Research existing implementations of X across [[research-discovery/arxiv/SKILL|arXiv]] and GitHub” |
...
- → [[writing/writing-for-agent-audiences/SKILL|writing-for-agent-audiences]] — REQUIRED: Load alongside when the audience is an
