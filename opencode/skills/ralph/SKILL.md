---
name: ralph
description: Use when triggered by "ralph", "set up ralph", "run ralph", "run the loop", or "implement tasks" - autonomous feature development with setup and execution phases
---
