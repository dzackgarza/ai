...
description: Use when calibrating task complexity, estimating token costs, or deciding
...
- [[prompt-engineering/SKILL|prompt-engineering]] — Crafts prompts appropriate to task complexity
