...
- Python code, Python packages, Pydantic models, uv scripts, or Python module layout:
  load [[code-patterns/python/python|code-patterns-python]].
...
- `references/error-handling.md` — legacy [[code-patterns/legacy/clean-code/clean-code|clean-code]] error-handling guidance, subordinate
