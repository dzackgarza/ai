---
name: code-patterns-general
description: Use when writing, reviewing, or refactoring code, looking for style guides
  and system coding conventions, and deciding naming, function shape, module boundaries,
  error handling, code style, or language-specific implementation patterns.
---
...
- Python code, Python packages, Pydantic models, uv scripts, or Python module layout:
  load [[code-patterns/code-patterns-python/SKILL|code-patterns-python]].
...
- `references/error-handling.md` — legacy [[code-patterns/legacy/clean-code/SKILL|clean-code]] error-handling guidance, subordinate
