...
The former separate skills [[git-guidelines/auth/SKILL|github-auth]], [[git-guidelines/pull-requests/SKILL|github-pr-workflow]], [[git-guidelines/review/SKILL|github-code-review]],
[[git-guidelines/issues/SKILL|github-issues]], and [[git-guidelines/repositories/SKILL|github-repo-management]] have been consolidated here.
...
- returned review and check feedback has been scanned with `extract_unresolved_issues`
  and routed through [[git-guidelines/feedback/SKILL|pr-feedback-triage]], or a real blocker has been reported.
