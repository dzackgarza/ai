...
metadata:
  hermes:
    ...
    related_skills: [subagent-driven-development, creating-implementation-plans, test-driven-development, git-guidelines, llm-failure-modes]
---
...
**creating-implementation-plans:** Validates implementation matches the plan requirements.
