...
### Citing Previous Results

When using a lemma or theorem, cite its exact statement:

```
By the Fundamental Theorem of Arithmetic [Thm 2.3], n has a unique prime factorization.
```
