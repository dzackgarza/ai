...
Pedagogical writing style for mathematical content: problem presentation, solution
structure, and proof technique norms.
...
- Be consistent with variable usage throughout a problem
- Clearly distinguish between different types of variables (scalars, vectors, functions)

### Equations and Expressions

- Display important equations on their own line
- Align related equations at the equals sign when possible
- Use proper spacing around operators and relations
...
- Show all steps in simplification
- Factor or expand expressions as needed
- Rationalize denominators when appropriate
- Combine like terms explicitly

### Derivative Calculations

- Use the limit definition when appropriate
- Show all steps in the difference quotient
- Clearly indicate when limits are being taken
- State the final derivative in simplified form
