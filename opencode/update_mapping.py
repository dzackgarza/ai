...
old_mapping = """AGENT_MAPPING = {
    ...
    # Subagents - Lattice
    "(Lattice) Internet Researcher": "readonly",
    "(Lattice) Documentation Librarian": "readonly",
    "(Lattice) Checklist Completionist": "readonly",
    "(Lattice) Test Coverage Auditor": "readonly",
    "(Lattice) Test Method Writer": "test_writer",
    "(Lattice) Interface Designer": "readonly",
    "(Lattice) Interface Implementer": "src_writer",
    "(Lattice) TDD Writer": "test_writer",
    "(Lattice) Algorithm Porter": "src_writer"
}"""
...
# Python's formatting via black messed up the exact string match, so let's parse and rewrite the AST
