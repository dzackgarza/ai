...
mode: primary
description: Primary orchestration agent for delegating work, maintaining operational
  state in memories or .agents, and driving work to completion without user Q&A.
fallback_models:
- openai/gpt-5.4
...
permission:
  external_directory:
    '*': deny
    /home/dzack/ai/opencode/skills/*: allow
  question: deny
  submit_plan: deny
