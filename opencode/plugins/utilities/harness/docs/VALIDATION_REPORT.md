...
- Notable output:
  ...
  - Subagent probe returned
    `{ "ok": true, "sessionID": "ses_34aec8ee7ffeswONmuUK9LExy7" }`
...
- Harness supports `send --async` via `/session/:id/prompt_async` and
  `wait --contains ...` for robust background testing.
