...
This workspace is both a git repo subtree and the live OpenCode config directory.
Cleanup should preserve runtime-discovered paths while reducing root sprawl.
...
- One-off migrations, probes, logs, and scratch artifacts belong in git history, not the
  live tree
