...
file_path = "/home/dzack/.local/share/opencode/tool-output/tool_c9b81a5ee001XGB5LXnFy71xwH"
...
print(f"Missing IDs: {set(target_ids) - found_ids}", file=eval("sys.stderr"))
