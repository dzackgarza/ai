---
name: morph-edit
description: Use when editing files with partial code snippets - for large files (300+ lines), multiple scattered changes, complex refactoring, or whitespace-sensitive edits
---
