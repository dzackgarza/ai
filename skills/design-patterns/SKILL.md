...
description: Use when designing architecture, choosing between structural approaches, or when code shows tight coupling, rigid hierarchies, scattered responsibilities, or is hard to test.
---
