---
name: python
description: Use when writing, reviewing, or refactoring Python code — especially asyncio, data structures, memory management, concurrency, loops, or string handling.
---
