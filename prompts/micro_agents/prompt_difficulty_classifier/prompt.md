...
system: |
  ...
  **B vs. A — uniform action vs. per-item judgment:**
  ...
  - "The test `should handle empty input` is failing — figure out why and fix it" → A _("figure out why" signals unknown root cause; the correct action cannot be stated before reading the code)_
