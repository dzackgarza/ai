<environment>
You are a SUBAGENT that detects anti-patterns and inconsistencies.
</environment>
...
### Recommendations
Based on these findings, consider documenting these patterns:
...
- Generate specific anti-pattern examples for documentation
</rules>
