...
def main() -> None:
    ...
    lines.append("## Review thread index")
    lines.append("")
    lines.append("_Gardener run: <workflow-run-url>_")
    lines.append("_Last updated: <ISO-8601-timestamp>_")
    lines.append('_Comments processed in this run: <list of IDs or "all">_')
    lines.append("")
